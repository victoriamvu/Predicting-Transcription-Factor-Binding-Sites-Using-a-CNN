...
This project aims to predict transcription factor binding sites in eukaryotic DNA using a lightweight 1D CNN. Our goal is to determine whether a given 200 bp DNA sequence contains a binding site for a single transcription factor.
...
JASPAR Database (https://jaspar.genereg.net/) – Provides validated TF binding sites for various transcription factors.
